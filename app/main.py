...
from mindfold3d.shape_generation import generate_shape_from_features, generate_shape_advanced, generate_mirror_reflection, generate_part_permuted_distractor, analyze_shape_features, canonical_voxel_form, nudge_voxels_until_unique, keep_largest_component
from mindfold3d.skeleton_generation import generate_shape_skeleton
from mindfold3d.cognitive_mapping import get_difficulty_spec, get_skeleton_spec, perturb_skeleton_spec, SHAPE_DIMENSIONS, TASK_DIMENSIONS, reverse_map_cognitive_profile, cognitive_profile_to_dict
import json
...
def coaching_status():
    ...
    from app.llm_coaching import check_llm_available, LLM_MODEL, LLM_BASE_URL
